/**
  ...
  */
  ...
  extern void get_power_heat_data_mode(__packed uint16_t* value, int mode);
  extern uint16_t get_heat_auto(void);
  extern uint16_t get_heat_limit(void);
  extern void get_robot_info_id(__packed uint8_t* value);
  extern void get_robot_info_hp(__packed uint16_t* value);
  extern int get_robot_shoot_power(void);
  extern void get_all_robot_hp_mode(__packed uint16_t* value, int mode);
  extern uint8_t get_game_status_progress(void);
  extern void get_game_status_time(__packed uint16_t* value);
  extern void get_robot_shoot_speed(__packed float* value);
