...
#define KI_GIMBAL_YAW_BA_ANGLE (0.0f)
...
#define KI_GIMBAL_YAW_UP_ANGLE (0.0f)
#define KD_GIMBAL_YAW_UP_ANGLE (0.0f)
#define MAX_OUT_GIMBAL_YAW_UP_ANGLE (5.0f)
#define MAX_IOUT_GIMBAL_YAW_UP_ANGLE (0.0f)
// VELOCITY:角速度
#define KP_GIMBAL_YAW_UP_VELOCITY (1000.0f)
#define KI_GIMBAL_YAW_UP_VELOCITY (0.0f)
#define KD_GIMBAL_YAW_UP_VELOCITY (0.0f)
#define MAX_OUT_GIMBAL_YAW_UP_VELOCITY (5000.0f)
